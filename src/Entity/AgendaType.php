...
/**
 * Defines the agenda type entity.
 *
 * @ConfigEntityType(
 *   id = "oe_agenda_type",
 *   label = @Translation("Agenda type"),
 *   bundle_of = "oe_agenda",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "label",
 *   },
 *   config_prefix = "oe_agenda_type",
 *   config_export = {
 *     "id",
 *     "label",
 *     "description",
 ...
 *   links = {
 *     "add-form" = "/admin/structure/oe_agenda_type/add",
 *     "edit-form" = "/admin/structure/oe_agenda_type/{oe_agenda_type}/edit",
 *     "delete-form" = "/admin/structure/oe_agenda_type/{oe_agenda_type}/delete",
 *     "collection" = "/admin/structure/oe_agenda_type",
 *   }
 * )
 */
class AgendaType extends SubEntityTypeBase {}
